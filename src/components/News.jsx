          ...
          <div class="container">
            ...
            <div class="card-news mt-5 mx-auto col-lg-3 col-md-12">
              ...
              <div class="card-body">
                ...
                <p class="card-text">
                  {" "}
                  Mahasiswa program studi kedokteran Universitas Palangka Raya kembali menorehkan prestasi membanggakan...
                </p>
                <a href="/news7" class="btn btn-primary">
                  Read more
                </a>
              </div>
            </div>
            ...
            <div class="row">
              <div class="card-news mt-5 mx-auto col-lg-3 col-md-12">
                ...
                <div class="card-news-body">
                  <h5 class="card-news-title">
                    2 Madrassa students win gold at IICYMS 2023 for creating
                    apps for students with disabilities
                  </h5>
                  <p class="card-text">
                    2 Madrasah students win gold at 2023 IICYMS 2 Madrasah
                    students win gold at 2023 IICYMS". For more details visit...
                  </p>
                  <a href="/news4" class="btn btn-primary">
                    Read more
                  </a>
                </div>
              </div>
              <div class="card-news mt-5 mx-auto col-lg-3 col-md-12">
                ...
                <div class="card-news-body">
                  ...
                  <p class="card-text">
                    Unsoed student wins gold medal at IICYMS for degrading drug
                    waste...
                  </p>
                  <a href="/news5" class="btn btn-primary">
                    Read more
                  </a>
                </div>
              </div>

              <h2 class="text-center">News 2022</h2>
              <div class="card-news mt-5 mx-auto col-lg-3 col-md-12">
                <img
                ...
                <div class="card-body">
                  <h5 class="card-news-title">
                    UNAIR students win silver medal at International Invention
              ...
              <div class="card-news mt-5 mx-auto col-lg-3 col-md-12">
                ...
                <div class="card-news-body">
                  <h5 class="card-news-title">
                    UB Student Team Won Award at the 2022 IICYMS International
                    Competition
                  </h5>
                  <p class="card-text">
                    {" "}
                    A collaboration of students team from the Faculty of
                    Engineering (FT), Faculty of Mathematics and Natural
                    Sciences (F-MIPA), and the Faculty of Economics and Business
                    (FEB) Universitas Brawijaya (UB) won the Silver Medal...
                  </p>
              ...
              <div class="card-news mt-5 mx-auto col-lg-3 col-md-12">
                ...
                <div class="card-news-body">
                  ...
                  <p class="card-text">
                    {" "}
                    (Unila): The Lampung University (Unila) team led by Indah
                    Sukma Ningsih (Biology 2018) and consisting of Raihan
                    Adhiyatma Atalla (Biology 2019), Al Khasanah (Agricultural
                    Product Technology 2019), Susanto (Agronomy 2018), and
                    Renaldy Jovanda (History Education 2019) won a silver
                    medal....
                  </p>
