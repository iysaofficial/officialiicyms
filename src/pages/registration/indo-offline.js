...
function IndonesiaOffline() {
  ...
  const scriptURL =
    "https://script.google.com/macros/s/AKfycbxHSf-z_I1UUt3Lno2xYzSQrb75YJvgZNRbRvhXY1BiTWHP-p8Gun1Q2Vu0M_OhgXeL/exec";
        ...
        <div class="container">
          <div class="content">
            ...
            <h4 className="text-xl">
              HALLO PESERTA IICYMS 2025, Mohon perhatikan informasi berikut ini
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  <label for="INFORMATION_RESOURCES" className="form-label">
                    Sumber Informasi Kompetisi IICYMS 2025
                  </label>
                  <select
                    type="text"
